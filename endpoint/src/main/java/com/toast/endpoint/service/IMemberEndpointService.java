 ...
 * @describe
 */
public interface IMemberEndpointService {
     ...
     */
    Map<String, Object> login(MemberDTO dto);
     ...
     * key = data：用户数据集合
     */
    Map<String, Object> split(long currentPage, long lineSize, String column, String keyword);
}
